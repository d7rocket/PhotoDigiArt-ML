...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None) -> None:
        ...
        self._prev_values: dict[str, float] = {
            ...
            # PBF simulation params
            "solver_iterations": float(SIM_COHESION_DEFAULT),
            "home_strength": SIM_HOME_STRENGTH_DEFAULT,
            "noise_amplitude": SIM_FLOW_INTENSITY_DEFAULT,
            "breathing_rate": SIM_BREATHING_RATE_DEFAULT,
            "noise_frequency": SIM_FLOW_SCALE_DEFAULT,
            "vorticity_epsilon": SIM_SWIRL_DEFAULT,
            "xsph_c": SIM_SMOOTHING_DEFAULT,
            "damping": SIM_DAMPING_DEFAULT,
            "breathing_amplitude": SIM_BREATHING_DEPTH_DEFAULT,
        }
